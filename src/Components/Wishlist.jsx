...
export default function Wishlist() {
  ...
  return (
    <div className="profileData">
      ...
      <div className="d3 Top">My Wishlist</div>
        <div className="d3 Right">My Wishlist</div>
        <div className="d3 Bottom">My Wishlist</div>
        <div className="d3 Left">My Wishlist</div>
        <div className="d3 Up"></div>
        <div className="d3 Down">My Wishlist</div>
      </div>
    </div>
  );
}
